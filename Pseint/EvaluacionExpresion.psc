Función resultado <- ResolverMultiplicacionDivision(numero1,operador,numero2)
...
Función resultado <- ResolverSumaResta(numero1,operador,numero2)
	Si operador='+' Entonces
		resultado <- numero1+numero2
	SiNo
		resultado <- numero1-numero2
...
Función prioridad <- ObtenerPrioridad(operador)
